...
// Tue Jul  7 03:31:19 2015 by ROOT version 5.34/18
// from TTree EventTree/Event data
// found on file: ../../../../Samples/Photons/job_spring15_gjet_pt20to40_MGG_80toInf_50ns.root
//////////////////////////////////////////////////////////
...
#ifdef SP15_cxx
SP15::SP15(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../../../../Samples/Photons/job_spring15_gjet_pt15to6000_25ns.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../../../../Samples/Photons/job_spring15_gjet_pt15to6000_25ns.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../../../../Samples/Photons/job_spring15_gjet_pt15to6000_25ns.root:/ggNtuplizer");
...
Int_t SP15::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SP15::LoadTree(Long64_t entry)
{
