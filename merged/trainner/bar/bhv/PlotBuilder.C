...
void PlotBuilder(){
  ...
  TFile *finput = new TFile( "../../../CutTMVABarrel90.root");
  ...
  for(int i = 0; i < t_S->GetEntries(); i++){
    ...
    if((sieie  < sieL)&&
       ...
       (isoC   < isoCL)&&
       (isoN-(0.014*Ppt+0.000019*Ppt*Ppt) < isoNL)){
    ...
    if((sieie  < sieT)&&
       ...
       (isoC   < isoCT)&&
       (isoN - (0.014*Ppt+0.000019*Ppt*Ppt) < isoNT)){
    ...
    if(isoN-(0.014*Ppt + 0.000019*Ppt*Ppt) < isoNL){
    ...
    if(isoP -0.0053*Ppt < isoPM){    
      EffPTMp->Fill(Ppt,weight);
    }    
    if(isoC   < isoCM){
      EffPTMc->Fill(Ppt,weight);
    }
    if(isoN-(0.014*Ppt + 0.000019*Ppt*Ppt) < isoNM){
    ...
    if(isoP -0.0053*Ppt < isoPT){    
      EffPTTp->Fill(Ppt,weight);
    }    
    if(isoC   < isoCT){
      EffPTTc->Fill(Ppt,weight);
    }
    if(isoN-(0.014*Ppt + 0.000019*Ppt*Ppt) < isoNT){
