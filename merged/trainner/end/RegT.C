...
void RegT(){
  ...
  //Output file 
  TString outfileName( "Tight_END_r_new.root" );
  ...
  factory->AddVariable( "(isoN-(0.0139*Ppt+0.000025*Ppt*Ppt) > 0 ) ? isoN-(0.0139*Ppt+0.000025*Ppt*Ppt) : \
0.0 ",'F' );
  ...
  TString fname = "../../CutTMVAEndCap90.root";
