...
void PlotBuilder(){
  ...
  TFile *finput = new TFile( "../../../CutTMVAEndCap90.root");
  ...
  for(int i = 0; i < t_S->GetEntries(); i++){
    ...
    if((sieie  < sieL)&&
       ...
       (isoC   < isoCL)&&
       (isoN-(0.0139*Ppt+0.000025*Ppt*Ppt) < isoNL)){
    ...
    if((sieie  < sieM)&&
       ...
       (isoC   < isoCM)&&
       (isoN- (0.0139*Ppt+0.000025*Ppt*Ppt) < isoNM)){
    ...
    if((sieie  < sieT)&&
       ...
       (isoC   < isoCT)&&
       (isoN - (0.0139*Ppt+0.000025*Ppt*Ppt) < isoNT)){
    ...
    if(isoN-(0.0139*Ppt + 0.000025*Ppt*Ppt) < isoNL){
